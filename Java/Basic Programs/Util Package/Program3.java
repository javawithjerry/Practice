...
public class Program3 extends Object            //wait method
{
	private List synchedList;
	   ...
	   {
	      synchronized (synchedList)         // while the list is empty, wait
	      {
	   ...
	   public void addElement(String element)   	   // method to add an element in the list
	   {
	   ...
	   {
	      final Program3 demo = new Program3();
